...
-- Atualizar INFO para INFORMATICA
...
-- Listar pedidos de uma so categoria
...
-- Listar pedidos onde o preco esteja entre R$ 3.000,00 e R$ 10.000,00

SELECT *
FROM Pedido
WHERE Preco BETWEEN 3000.00 AND 10000.00

-------------------------------------------------------------------------------------------------------------------

-- Remover os pedidos que tem quantidade igual a 1 e tambem os que foram feitos pela Bia

DELETE FROM Pedido
WHERE Quantidade = 1 OR Cliente = 'BIA'
